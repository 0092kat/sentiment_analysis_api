...
model_filename = os.path.join(current_dir, '..', 'model_files', 'logistic_regression_model.pkl')
#model_filename = '../model_files/logistic_regression_model.pkl'
model = joblib.load(model_filename)

vectorizer_filename = os.path.join(current_dir, '..', 'model_files', 'tfidf_vectorizer.pkl')
#vectorizer_filename = 'django/sentiment_analysis_api/model_files/tfidf_vectorizer.pkl'
